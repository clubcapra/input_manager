...
**READONLY_example_config.yaml shall NOT BE MODIFIED or used at runtime**. It is an example with commments explaining how a config file should be made to support a device.
